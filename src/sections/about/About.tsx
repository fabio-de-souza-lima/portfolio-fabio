  ...
  return (
    <AnimatedFadeIn>
      <div className="pt-24 col-span-1 text-(--text-color) flex flex-col gap-3" id="about">
        ...
        <p>Profissional em transição de carreira para a área de Desenvolvimento de Tecnologia, 
          ...
          contribuir com equipes dinâmicas e evoluir profissionalmente dentro do setor de tecnologia.</p>
        ...
        <p>Profissional em transição de carreira para a área de Desenvolvimento de Tecnologia, 
          ...
          Perfil proativo, adaptável e orientado a resultados, com grande interesse em atuar em projetos de inovação, 
          soluções digitais e melhoria de processos.</p>

        <p>Atualmente, estou concluindo a graduação em Ciência da Computação, cursando o oitavo semestre,
           o que reforça meu compromisso com a evolução profissional e a consolidação de conhecimentos na área de tecnologia.</p>
      </div>
    </AnimatedFadeIn>
