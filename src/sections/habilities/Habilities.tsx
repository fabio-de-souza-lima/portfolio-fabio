...
function Habilities() {
  return (
    <AnimatedFadeIn>
      <div className="pt-24 px-4 sm:px-0 max-w-7xl mx-auto" id="habilities">
        <h2 className="text-4xl text-white font-semibold mb-2">Habilidades</h2>
        <p className="text-base text-gray-400 mb-12">Tecnologias que utilizo no dia a dia</p>

        {Techs.map((section) => (
          <div key={section.name} className="mb-12 w-full">
